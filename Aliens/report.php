...
?>
  ...
  <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    Yes <input id="fangspotted" name="fangspotted" type="radio" value="yes" <?php $fang_spotted = $fang_spotted??''; echo ($fang_spotted == 'yes' ? 'checked="checked"' : ''); ?> />
    No <input id="fangspotted" name="fangspotted" type="radio" value="no"  <?php  $fang_spotted = $fang_spotted??''; echo ($fang_spotted == 'no' ? 'checked="checked"' : ''); ?> /><br />
