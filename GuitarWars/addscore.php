...
<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    //check captcha pass phrase
    $captcha = sha1(trim($_POST['captcha']));
...
?>
  ...
  <form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <input type="text" id="captcha" name="captcha" placeholder="Enter the verfication code" />
